...
!function(a, b) {
    ...
    var n = {
        dialog     : "<div class='bootbox modal' role='dialog'><div class='modal-dialog'><div class='modal-content'><div class='modal-body'><div class='bootbox-body'></div></div></div></div></div>",
    ...
    p.alert = function() {
        ...
        if (g(j, function(a, b) {
            ...
            }), i.find(".bootbox-body").html(a.message), a.animate === !0 && d.addClass("fade"), a.className && d.addClass(a.className), "large" === a.size ? f.addClass("modal-lg") : "small" === a.size && f.addClass("modal-sm"),"full" === a.size ? f.addClass("modal-full") : f.addClass(""),"middle" === a.size ? f.addClass("modal-md") : f.addClass(""), a.title && i.before(n.header), a.closeButton) {
